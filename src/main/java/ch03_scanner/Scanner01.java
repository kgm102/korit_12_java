...
//        System.out.println(name);
        /*
                ...
                그 변수(name)을 println하는 것이 가능하다 정도로 아는 것으로 충분합니다.
                ...
                2. next(int / double / boolean, ... etc) vs. nextLine
                    ...
                    -> 그래서 scanner.nextLine() 으로 사용했을 때 어제 kim il로 띄어쓰기 했을 때 저장이
                        가능했습니다.
                    - 나머지는 허용이 안됩니다. 그래서 kim 2를 하니까 kim만 저장됐었습니다. 그리고 kim2로
                        바꿔 저장했을 때만 가능했습니다.
...
//        System.out.println("이름 : " + name2);
        ...
        /*
            이상의 코드에서의 문제점은 라인이 실행됫을 때 데이터를 입력 받지 않고
            그대로 넘어가서 49번 라인과 50번 라인이 실행된다는 점입니다.
            이상의 문제는 nextInt()에서 값을 입력하고 enter를 치게 되는데,
            그 경우 다음 nextLine()에서 enter키를 받아들여서 빈 값인 상태로 enter를
            쳤다고 알아듣기 때문에 곧장 48번 라인이 실행됫습니다.
