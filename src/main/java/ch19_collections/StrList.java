...
public class StrList {
    public static void main(String[] args) {
        ...
        /*
            특정 element의 검ㅅ개(list 내의) -> .contains() 메서드 사용.
            리스트명.contains(목적어)
         */
        ...
        for(String strarray1 : strArray){
            System.out.print(strarray1 + " 학생 - ");
        }
        System.out.println();

        // list는 index 추출할 때 리스트명.size() 를 씁ㄴ디ㅏ. .length 아니고, method인 점 주의
