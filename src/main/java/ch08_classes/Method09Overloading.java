...
/*
    method overloading
        ...
        동일한 메서드 명을 지닌 메서드 '들ㅇ'을 정의할 수 있다.

        즉, 메서드 명은 동일하고, 매개변수에 들어가는 저료형, 개수를
        ...
        method overloading의 장점 :
            ...
            int끼리의 합 연산을 한느 메서드를 나눈다고 가정했을 때,
            add,
            plus,
            connect 등을 정의했다면,
            ...
            와 같은 식으로 매개변수의 개수의 차이를 두더라도 '동일한 기능을 하는 서로
            다른 메서드'들로 인식하게끔 하는 방식입니다.

            그러면 메서드 명들도 동일하고, 걔네가 뭐 매개변수 유형이가 개수가 차이가 있겠
            지만 기능도 같으니까 머리가 안아프다는 장점이 있다고 할 수 있습니다.
 */
public class Method09Overloading {
    ...
    public static void main(String[] args) {
       // 객체생성
        Method09Overloading method = new Method09Overloading();
        method.add();
        method.add("5");
        method.add(5,5);
    }
