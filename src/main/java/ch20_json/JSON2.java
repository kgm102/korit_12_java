...
public class JSON2 {
    public static void main(String[] args) {
        ...
        productMap1.put("productName","MYWY3KH/A");
        productMap1.put("productCode","아이폰 16 프로 맥스");
        ...
        /*
            이사으이 두 사례에서 toJson()이라는 메서드는 argument로 Java Object 자체를 넣는것도,
            Map으로 생성되 entry를 Json 형태로 바꾸는 것도 가능하다는 것을 확인할 수 있습니다.
            그리고 JsonObject 객체도 바꿀 수 있었네요.

            그러면 반대로 json -> Map / Java Object로 바꾸는 것도 가능하겟네요.

            근데 String data인 json "" 포함해서 생성하는게 너무 귀찮기 때문에
            user1과 productMap1을 json으로 바꾼 데이터로 바꿔보도록 하겠습니다.
