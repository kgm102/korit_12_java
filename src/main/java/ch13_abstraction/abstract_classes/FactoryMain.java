    ...
    public static void main(String[] args) {
      ...
      factory1.produce("모니터");    // 생성되었고, method 호출도 된다는 점이 문제입니다.
        /*
            ...
            (Lamda Expression)으로 대체되는 경우가 많습니다(그리고 JavaScript에서도 동일한 방식을
            사용합니다.

            재사용하지 않고 한 번만, 즉 이 경우에는 FactoryMain에서만 한 번 쓰고 치운다면 사용하기
            좋습니다.

            저희는 교육 상황기기 때문에 모든 클래스를 한 번 정의하고 그걸로 객체 한 두 개 만들고 치우는
            경우가 ㅁ낳아서 모든 수업을 위처험 익명 클래스로 정읳랄 수도 있지만
        ...
        /*
            어제 상속 배운 부분과 합쳐서 생각ㅇ르 해볼 때, 추상 클래스는
