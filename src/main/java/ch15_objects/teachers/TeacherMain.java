...
public class TeacherMain {
    public static void main(String[] args) {
        ...
        // 재정의하고 나니깐 true로 바뀌어있습니다.

        /*
            이상의 코드에서 중요한 점은 재저으이 전과 후가 결과값이 다르다는겁니다.
            Teacher에서 .equals()를 재정의하기 전에는 false가 떴었습니다.
            그땐느 teacher1와 teacher2의 주소지까지 확인하여 같은지 아닌지의 여부를 확인했다면
        ...
        /*
            teacher3의 자료형은 ch15_objects.Teacher이자
            ch15_objects.teacher.Teacher가 아니기 때문에 내부에 동일한 값이 들어가 있다고 하더라도
