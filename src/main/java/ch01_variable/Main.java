...
/*
    주석(coment) : Java 프로그램의 경우 폴더 및 파일의 전체 코드를 컴파일링
        하는데, 거기서 오류가 하나라도 발생하게 되면 전체 프로그램이 실행 x.
        하지만 주석 처리를 한 부분에 대해서는 컴퓨터가 코드로 인지하지 않기 째문에 오류가 발생하지 않습니다.

        즉, 주석이란 컴퓨터가 읽어서 처리하는 부분이 아니라 사람이 읽어서
            정보를 얻을 수 있는 것에 의의가 있습니다.
        1) 한 줄 주석 : //
        2) 다중 주석 : / + shift + 8 + enterE
...
public class Main {
    public static void main(String[] args) {
        ...
        /*
            ...
            이라고 합니다.
            하드 코등 : 명령문에(변수에 대입되지 않은 데이터인데 이를 리터럴(literal))를 바로
            집어넣는 것으로 '지양'되는 방식
        ...
        String introduction = "안녕하세요, 저는 이번 국비 과정을 맡게 된 김규민입니다.";
        ...
        /*
            Java에서의 변수 명명 규칙 :
                ...
                cf) python 변수 표기 방식은 스네이크 표기법(snake case)
        ...
        // 근데 74 라인의 경우에 변수의 자료형이 char인데 문자가 아닌 여러 개 나오는 바람에 결과값이
        // 의도대로 나오지 않음
