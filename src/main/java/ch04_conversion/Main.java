...
public class Main {
    public static void main(String[] args) {
        ...
        // 이상의 경우에는 변수를 선언할 때 변경되기르 원하는 자료형으로 명시해줍니다.

        // 다운 캐스팅 : 용량이 더 작은 자료형으로 변형하는 것을 의미
        int cast4 = 99; // # 1 방법으로
        ...
        /*
            이상의 코드에서 처음에 41번 라인을 업캐스팅 # 2 방식으로 처리하려고 했을 때,
            오류가 나는 것은 당연한 부분입ㄴ디ㅏ.
            추후 수업에서 더 중요하게 적용되는 개념인데, 업캐스팅의 경우 메모리 용량이
            커지면 되니까 기본 데이터의 변형이 일어날 가능성이 없어서 암시적(implicit)으로
            변경히 가능한 반면,
