...
public class ProductviewMain {
    public static void main(String[] args) {
        ...
        // 생성자가 private 불가능
//        PruductView pruductView1 = new PruductView();
        System.out.println(PruductView.count);
        System.out.println(PruductView.getInstance().toString());
